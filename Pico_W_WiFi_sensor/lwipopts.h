...
#define MEMP_NUM_SYS_TIMEOUT        16  // Increase timeout pool for MQTT + TCP tests
...
// Increase max SSI tag name length to support longer tag names
#define LWIP_HTTPD_MAX_TAG_NAME_LEN 12
// use generated fsdata
#define HTTPD_FSDATA_FILE "wifi_setup/my_fsdata.c"
